...
/**
 * Read-only access to {@code public.tenants} — <strong>test-only</strong> (EN53.1 Vague 1).
 *
 * <p>See {@link fr.pivot.agilite.testsupport.auth.entity.PlatformAccessToken}'s class Javadoc.
 * Extends Spring Data's bare {@link Repository} marker — not {@code JpaRepository} — so no
 * {@code save}/{@code delete} method is ever exposed: never writes to {@code tenants}.
 */
