...
public record TimerTickEvent(
    ...
    public TimerTickEvent(
            ...
            final long remainingSeconds, final long overtimeSeconds) {
        this(EVENT_TYPE, meetingId, agendaItemId, elapsedSeconds, remainingSeconds, overtimeSeconds);
    }
}
